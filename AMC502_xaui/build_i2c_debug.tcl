...
connect_debug_port u_ila_0/clk [get_nets clk20mhz]
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe0]

set debug_nets { amc502_imp/i2c_strobe \
                 scl_l1 \
                 sda_l1_in \
                 sda_l1_out \
                 sda_l1_t \
                 amc502_imp/i2c_den \
                 amc502_imp/i2c_wen \
                 {amc502_imp/i2c_l1_imp/i2c_state[*]} \
                 {amc502_imp/i2c_l1_imp/byte[*]} \
                 {amc502_imp/i2c_l1_imp/i2c_daddr[*]} \
               }
set n 0
